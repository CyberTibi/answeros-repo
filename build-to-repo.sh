...
rm -f $REPO_DIR/$DB_NAME.db
rm -f $REPO_DIR/$DB_NAME.files
mv $REPO_DIR/$DB_NAME.db.tar.gz $REPO_DIR/$DB_NAME.db
mv $REPO_DIR/$DB_NAME.files.tar.gz $REPO_DIR/$DB_NAME.files
